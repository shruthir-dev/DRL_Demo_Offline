package com.ml.shivay_couchbase.docqa.ui.screens
...
import com.ml.shivay_couchbase.docqa.ui.theme.DocQATheme
import com.ml.shivay_couchbase.docqa.ui.viewmodels.DocsViewModel
...
private fun ColumnScope.DocsList(docsViewModel: DocsViewModel) {
    ...
    LazyColumn(modifier = Modifier.fillMaxSize().weight(1f)) {
        items(docs) { doc ->
            DocsListItem(
                doc.copy(docText = doc.docText.take(200)),
